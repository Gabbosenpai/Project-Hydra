...
func login_with_custom_id(custom_id: String, create_user: bool, info_request_parameters: GetPlayerCombinedInfoRequestParams):
	...
	var result = _post(request_params, "/Client/LoginWithCustomID", _on_login)

## Login into PlayFab using an user authentication token generated by SteamAPI.[br]
## [param steam_auth_ticket]: Generated steam authentication token for the user (String composed of hexadecimal)[br]
## [param is_auth_ticket_for_api]: True if ticket was generated using GetAuthTicketForWebAPI(), false if it was generated using GetAuthSessionTicket[br]
## [param create_account]: Automatically create a PlayFab account if one is not currently linked to this ID[br]
## [param info_request_parameters]: Flags for which pieces of info to return for the user
